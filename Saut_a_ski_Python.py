...
plt.xlabel('Abscisse X')   # Nommer l'axe des abscisses (Etiquette l'axe des abscisses)
plt.ylabel('abscisse Y')             # Nommer l'axe des ordonnées (Etiquette de l'axe des ordonnées)
...
for i in range(0,N-1,2):
    plt.arrow(xs[i], ys[i],
              ...
              width=0.5, color='gray', length_includes_head="true")
